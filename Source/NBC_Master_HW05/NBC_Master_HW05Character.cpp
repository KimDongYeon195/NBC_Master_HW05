...
#include "NBC_Master_HW05Character.h"
...
ANBC_Master_HW05Character::ANBC_Master_HW05Character()
{
...
void ANBC_Master_HW05Character::NotifyControllerChanged()
{
...
void ANBC_Master_HW05Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ANBC_Master_HW05Character::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ANBC_Master_HW05Character::Look);
	}
	else
	{
...
void ANBC_Master_HW05Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
